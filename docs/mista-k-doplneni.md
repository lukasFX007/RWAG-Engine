...
Formát: `50.54861, 15.23310` a případně rádius v metrech (bez něj se počítá 25 m).
...
Autor to nechal otevřené (Q08b): v okruhu hry je dnes jen Troskovice, ale osad, které se ve středověku za obec počítaly, je víc. Doplňte prosím střed a rádius u každé, kterou má hra brát jako obec.
...
Kam hra skupinu posílá. Stačí ta místa, u kterých má smysl polohu kontrolovat — u „vraťte se, odkud jste přišli“ to smysl nemá.
...
- **C15** · Občerstvěte se ve mlýně (deed)
- **D04** · Poskládejte u každého ohniště hromádku dříví (nature)
- **D08** · Sedněte si s někým na pivo a kus řeči (deed)
- **E05** · Úkol [😐/😡]: Každý z vás si něco objedná (deed)
